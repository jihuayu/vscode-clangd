...
if (fs.existsSync(`./l10n/bundle.l10n.${lang}.json`)) {
    lang_file = fs.readFileSync(`./l10n/bundle.l10n.${lang}.json`, { encoding: 'utf8' });
}
...
for (const key in newLangMap) {
    if (oldLangMap[key]) newLangMap[key] = oldLangMap[key]
}

fs.writeFileSync(`./l10n/bundle.l10n.${lang}.json`, JSON.stringify(newLangMap, null, 2).replace("\\\\", "\\"), { encoding: 'utf8' })
